...
<title>SA-YES | {if isset($calendartypeData)}Edit Calendar Type{else}Add a Calendar Type{/if}</title>
...
<div id="container">
  ...
  <div id="content">
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/calendar/types/details.php{if isset($calendartypeData)}?code={$calendartypeData.calendartype_code}{/if}" method="post">
		...
		<tr>
			...
			<td><input type="text" name="calendartype_colour" id="calendartype_colour" value="{$calendartypeData.calendartype_colour}" size="60"/><p>Please make this a one letter word with no capital letters.</td>
		</tr>			  				  
        </table>
      </form>
	</div>
