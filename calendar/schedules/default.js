		...
		function(data) {
			if(data.result) {
				...
				for(var i = 0; i < data.records.length; i++) {
					...
					html += '<td valign="top"><a href="/calendar/schedules/details.php?code='+item.calendar_code+'">' + item.calendar_name + '</a></td>';
					...
					html += '<td valign="top">' + item.attendees.substring(0,100) +' .... ('+item.attendeesnumber+')</td>';								
					} else {
			...
			tblhtml = '<table id="dataTable" class="display" style="table-layout: fixed"><thead><tr><th>By</th><th>Name</th><th>Date</th><th>Address</th><th>Attendees</th><th></th></tr></thead><tbody id="dataTableContent">'+html+'</tbody></table>';
