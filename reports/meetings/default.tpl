  ...
  <div id="content">
    ...
    <div class="filter_double">
		<div id="searchBar" class="left">    				  
				...
				<input type="text" name="mentorsearch" id="mentorsearch" value="{$mentorsearch}" size="20" /> &nbsp;
				<input type="hidden" name="smentorid" id="smentorid" value="{$smentorid}" />
				<strong class="line fl mrg_left_20">Mentee:</strong>			
				<input type="text" name="menteesearch" id="menteesearch" value="{$menteesearch}" size="20" /> &nbsp;
				<input type="hidden" name="smenteeid" id="smenteeid" value="{$smenteeid}" />		
		 </div>
		<div class="clearer"><!-- --></div>	
