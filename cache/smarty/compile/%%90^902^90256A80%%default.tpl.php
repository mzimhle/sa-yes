<?php /* Smarty version 2.6.20, created on 2014-11-04 15:14:43
         compiled from users/mentorapplications/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'users/mentorapplications/default.tpl', 37, false),)), $this); ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/users/mentorapplications/" title="">Mentor Applications</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Mentor Applications</h2>	<br />
    <div class="clearer"><!-- --></div>    
     <a href="/users/mentorapplications/details.php" title="Click to Add a new Mentor Application" class="blue_button fl mrg_bot_10"><span style="float:left;">Add a new Mentor Application</span></a> <br />
	 <!-- Start Search Form -->
    <div class="filter">
