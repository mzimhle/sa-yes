<?php /* Smarty version 2.6.20, created on 2014-05-22 09:10:05
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/account/" method="post">
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
          <tr>
            <td class="left_col<?php if (isset ( $this->_tpl_vars['errorArray']['usertype_code'] )): ?> error<?php endif; ?>"><h4>User Type:</h4></td>
			<td><?php echo $this->_tpl_vars['userData']['usertype_name']; ?>
</td>
          </tr>	  
		 <tr>
...
" size="10"/></td>	
          ...
          <tr>
            <td class="left_col<?php if (isset ( $this->_tpl_vars['errorArray']['area_code'] )): ?> error<?php endif; ?>"><h4>Area:</h4></td>
			<td colspan="3">			
				<input type="text" name="area_name" id="area_name" value="<?php echo $this->_tpl_vars['userData']['area_path']; ?>
" size="60" />
...
" size="60"/><br /> <?php if (isset ( $this->_tpl_vars['errorArray']['user_email'] )): ?><span style="color: red"><?php echo $this->_tpl_vars['errorArray']['user_email']; ?>
</span><?php endif; ?></td>
          </tr>
          <tr>
...
" size="60"/><br /> <?php if (isset ( $this->_tpl_vars['errorArray']['user_password'] )): ?><span style="color: red"><?php echo $this->_tpl_vars['errorArray']['user_password']; ?>
</span><?php endif; ?></td>
          </tr>
          <tr>
...
" size="60"/><br /> <?php if (isset ( $this->_tpl_vars['errorArray']['user_password2'] )): ?><span style="color: red"><?php echo $this->_tpl_vars['errorArray']['user_password2']; ?>
</span><?php endif; ?></td>
          </tr>			  
          <tr>
...
" size="60"/><br />E.g. 0215874698 <?php if (isset ( $this->_tpl_vars['errorArray']['user_telephone'] )): ?> - <span style="color: red"><?php echo $this->_tpl_vars['errorArray']['user_telephone']; ?>
          ...
          <tr>
            <td class="left_col<?php if (isset ( $this->_tpl_vars['errorArray']['user_admin_colour'] )): ?> error<?php endif; ?>"><h4>My Colour:</h4></td>
			<td><input type="text" name="user_admin_colour" id="user_admin_colour" value="<?php echo $this->_tpl_vars['userData']['user_admin_colour']; ?>
" size="60"/><br />E.g. red <?php if (isset ( $this->_tpl_vars['errorArray']['user_admin_colour'] )): ?> - <span style="color: red"><?php echo $this->_tpl_vars['errorArray']['user_admin_colour']; ?>
</span><?php endif; ?></td>
          </tr>		  
          <tr>
            <td class="left_col<?php if (isset ( $this->_tpl_vars['errorArray']['user_notes'] )): ?> error<?php endif; ?>" valign="top"><h4>Notes:</h4></td>
			<td><textarea name="user_notes" id="user_notes"  cols="70" rows="20"><?php echo $this->_tpl_vars['userData']['user_notes']; ?>
</textarea></td>
          </tr>			  
        </table>
      </form>
