<?php /* Smarty version 2.6.20, created on 2014-06-06 12:01:30
         compiled from users/menteeapplications/documents.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'users/menteeapplications/documents.tpl', 93, false),)), $this); ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li>Mentee Application - <?php echo $this->_tpl_vars['menteeappData']['menteeapp_name']; ?>
...
" class="button mrg_left_20 fl"><span>Mentee Details</span></a>   
		  <a href="/users/menteeapplications/application.php?code=<?php echo $this->_tpl_vars['menteeappData']['menteeapp_code']; ?>
" class="button mrg_left_20 fl"><span>Mentee Application</span></a>   
		  <a href="#" class="blue_button mrg_left_20 fl"><span>Mentee Documents</span></a>   
		</div>		
		<div class="clearer"><!-- --></div>
		<br />
		<div class="detail_box">
		  <form id="detailsForm" name="detailsForm" action="/users/menteeapplications/documents.php?code=<?php echo $this->_tpl_vars['menteeappData']['menteeapp_code']; ?>
...
function deleteitem(id) {
	if(confirm(\'Are you sure you want to delete this item?\')) {
		$.post("?code='; ?>
<?php echo $this->_tpl_vars['menteeappData']['menteeapp_code']; ?>
<?php echo '", {
				deleteitem	: id
			},
			function(data) {
