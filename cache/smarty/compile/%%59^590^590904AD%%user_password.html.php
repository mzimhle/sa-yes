<?php /* Smarty version 2.6.20, created on 2014-08-11 18:44:11
         compiled from mailers/user_password.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mailers/user_password.html', 24, false),)), $this); ?>
<html>
<head>
						...
						<table cellspacing="0" border="0" cellpadding="0" width="600">
							<tr>
								<td class="content-copy" valign="top" style="padding: 0 20px; color: #000; font-size: 14px; font-family: Georgia; line-height: 20px;" colspan="2">
									<br />Dear <?php echo $this->_tpl_vars['userData']['user_name']; ?>
 <?php echo $this->_tpl_vars['userData']['user_surname']; ?>
, <br /><br />
									Please find below your log in details for the SA-YES Transition to Indendent Living (TIL) Programme:<br /><br />
									Go to : <a href="http://meetings.sa-yes.com" target="_blank">http://meetings.sa-yes.com</a><br /><br />									
									Username: <b><?php echo $this->_tpl_vars['userData']['user_email']; ?>
</b><br />
									Password: <b><?php echo $this->_tpl_vars['userData']['user_decoded']; ?>
</b><br /><br />
									Once you have logged in please go to 'Manage My Account' and fill in any missing information.<br />
									<?php if ($this->_tpl_vars['userData']['category'] == 'mentor-login'): ?>
									<br />
									Then go to 'Manage Meetings' and click on 'Add a New Meeting'. You will need to do this on a weekly basis. We will send you a reminder.<br />
									<?php endif; ?>
									<br />
									<a style="text-decoration: none; color: red;" href="http://<?php echo $this->_tpl_vars['host']; ?>
