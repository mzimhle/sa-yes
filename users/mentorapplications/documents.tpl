  ...
  <div id="content">
	...
	<div class="inner"> 
		...
		<div class="mrg_top_10 fr">
		  <a href="/users/mentorapplications/details.php?code={$mentorappData.mentorapp_code}" class="button mrg_left_20 fl"><span>Mentor Details</span></a>   
		  <a href="/users/mentorapplications/application.php?code={$mentorappData.mentorapp_code}" class="button mrg_left_20 fl"><span>Mentor Application</span></a>   
		  <a href="#" class="blue_button mrg_left_20 fl"><span>Mentor Documents</span></a>   
		</div>		
		<div class="clearer"><!-- --></div>
		<br />
		<div class="detail_box">
		  <form id="detailsForm" name="detailsForm" action="/users/mentorapplications/documents.php?code={$mentorappData.mentorapp_code}" method="post" enctype="multipart/form-data">
...
function deleteitem(id) {
	if(confirm('Are you sure you want to delete this item?')) {
		$.post("?code={/literal}{$mentorappData.mentorapp_code}{literal}", {
				deleteitem	: id
			},
			function(data) {
				if(data.result) {			
